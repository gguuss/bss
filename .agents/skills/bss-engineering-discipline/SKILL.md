...
- Specific regression rules:
  ...
  - **Permissions Management & TCC Handling**: Permission checks must verify both CoreGraphics preflight and modern ScreenCaptureKit access, auto-refresh upon application activation, and provide an instant relaunch mechanism to handle macOS TCC restart requirements.
